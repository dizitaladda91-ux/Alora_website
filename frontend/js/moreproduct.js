...
function renderProductCatalog(products) {
    ...
    gridContainer.innerHTML = products.map(product => {
        ...
        `;
        return `
        <div data-product-id="${product.id}" class="animate-fade-in relative w-full flex-shrink-0 product-card bg-white rounded-2xl sm:rounded-3xl p-3 sm:p-4 shadow-sm hover:shadow-lg hover:-translate-y-1 border border-stone-200/80 flex flex-col justify-between transition-all duration-300 group">
            ...
            <div class="w-full h-[155px] sm:h-[185px] flex items-center justify-center my-1 relative">
                <a href="${product.productUrl}" class="w-full h-full flex items-center justify-center">
                    <img src="${product.baseImg}" alt="${product.name}" class="product-card-img max-h-full max-w-full object-contain transition-transform duration-300 group-hover:scale-105">
                </a>
            </div>
