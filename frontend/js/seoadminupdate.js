        ...
        if (blog.schema) {
            if (typeof blog.schema === 'object' && blog.schema !== null) {
                ...
                try {
                    ...
                    const parseFn = (typeof window.parseMultipleSchemas === 'function') ? window.parseMultipleSchemas : null;
                    const parsedMulti = parseFn ? parseFn(decoded) : null;
...
updateForm.addEventListener('submit', async function(e) {
    ...
    if (schemaVal) {
        const parseFn = (typeof window.parseMultipleSchemas === 'function') ? window.parseMultipleSchemas : null;
        const parsed = parseFn ? parseFn(schemaVal) : [1];
        if (parsed.length === 0) {
